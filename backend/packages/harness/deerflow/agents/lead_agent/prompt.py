...
- **SKILL ROUTING**: For codebase/repository analysis requests, prioritize loading and following the `codebase-analysis` skill workflow before planning execution.
